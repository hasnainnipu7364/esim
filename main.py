...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "\U0001F30D Choose a continent:", reply_markup=markup)
...
def show_countries(call):
    ...
    bot.edit_message_text(f"\U0001F4CD Countries in {selected_continent}:", chat_id=call.message.chat.id,
