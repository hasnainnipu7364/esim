...
def back_to_continents(call):
    ...
    for cont in continents:
        markup.add(InlineKeyboardButton(cont, callback_data=f"continent_{cont}"))
    bot.edit_message_text("Select your region or type your country to see eSIM plans", chat_id=call.message.chat.id,
                          message_id=call.message.message_id, reply_markup=markup)
...
def handle_message(message):
    ...
    if text.startswith("cheapest"):
        ...
        country_full = alias_map.get(user_input, user_input.title())
